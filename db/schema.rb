...
ActiveRecord::Schema.define(version: 20160719083626) do
  ...
  add_index "galleries", ["post_category_id"], name: "index_galleries_on_post_category_id"
  ...
  add_index "restoraunts", ["user_id"], name: "index_restoraunts_on_user_id"
  ...
  add_index "special_promotions", ["restoraunt_id"], name: "index_special_promotions_on_restoraunt_id"
  add_index "special_promotions", ["user_id"], name: "index_special_promotions_on_user_id"
